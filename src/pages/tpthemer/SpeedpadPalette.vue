        ...
        <div class="palette">
            ...
            >
                ...
                <div class="tp-controls">
                    <a class="pillar-word" @click.prevent="() => paintNeutral(cb)">neut</a>
                    <a class="pillar-word" @click.prevent="() => paintRed(cb)">red</a>
                    <a class="pillar-word" @click.prevent="() => paintBlue(cb)">blue</a>
                </div>
            </div>
        </div>
